...
{
    public partial class CtrlParamRatioAlm : XtraUserControl, ICtrlParamBase
    {
        public CtrlParamRatioAlm()
        {
            InitializeComponent();
        }
        ...
        public void LoadParam()
        {
            ...
            this.txt_inputAI.Enabled = !Block.IsLinkLeftPort(PIDRatioAlm.InputAI);
        }
