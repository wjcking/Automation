...
{
    public partial class CtrlParamSwitch : XtraUserControl, ICtrlParamBase
    {
        public CtrlParamSwitch()
        {
            InitializeComponent();
        }
        ...
        public void LoadParam()
        {
            ...
            this.txt_inputAI.Enabled = !Block.IsLinkLeftPort(PIDSwitch.InputAI);
        }
